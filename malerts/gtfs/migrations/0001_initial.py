...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gtfs_stop', (
            ...
            ('geopoint', self.gf('django.contrib.gis.db.models.fields.PointField')(default=(0, 0))),
        ...
        db.create_table('gtfs_shape', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shape_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.create_table('gtfs_trip', (
            ...
            ('shape_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        db.create_table('gtfs_stoptime', (
            ...
            ('drop_off_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtfs.DropOffType'], null=True, blank=True)),
        ...
        # Adding model 'Alert'
        db.create_table('gtfs_alert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('cause', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('effect', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('url', self.gf('django.db.models.fields.URLField')(default='http://www.metro.net/', max_length=200)),
            ('header_text', self.gf('django.db.models.fields.CharField')(default='', max_length=80)),
            ('description_text', self.gf('django.db.models.fields.CharField')(max_length=4000)),
            ('route', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtfs.Route'])),
        ))
        db.send_create_signal('gtfs', ['Alert'])
    ...
    models = {
        ...
        'gtfs.alert': {
            ...
            'cause': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'description_text': ('django.db.models.fields.CharField', [], {'max_length': '4000'}),
            'effect': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'end': ('django.db.models.fields.DateTimeField', [], {}),
            'header_text': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'route': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gtfs.Route']"}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'url': ('django.db.models.fields.URLField', [], {'default': "'http://www.metro.net/'", 'max_length': '200'})
        },
        'gtfs.block': {
        ...
        'gtfs.stop': {
            ...
            'desc': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'geopoint': ('django.contrib.gis.db.models.fields.PointField', [], {'default': '(0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
